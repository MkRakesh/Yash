...
if input1 != 0 :
    ...
    plt.plot(forecast_values,linewidth=.8,color='darkmagenta')
    plt.ylabel('Forecast',fontsize=9)
    plt.xticks(fontsize=9,rotation=45, ha="right",color='darkmagenta')
    plt.yticks(fontsize=9,color='darkmagenta')
    plt.grid()
